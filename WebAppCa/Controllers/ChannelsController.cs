...
namespace WebAppCa.Controllers
{
    public class ChannelsController : Controller
    {
        ...
        public ChannelsController(BroadCastContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ChannelId,Name,Description,Image")] Channel channel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChannelId,Name,Description,Image")] Channel channel)
        {
